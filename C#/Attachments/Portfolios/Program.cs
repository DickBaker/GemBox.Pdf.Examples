...
void SetFullNameFieldValue(PdfPortfolioFileCollection files, PdfPortfolioFolderCollection folders, string parentFolderFullName, PdfName portfolioFieldKey)
{
...
PdfPortfolioFolder GetOrAddFolder(PdfPortfolio portfolio, string fullName)
{
...
void ExtractFilesAndFoldersToArchive(PdfPortfolioFileCollection files, PdfPortfolioFolderCollection folders, ZipArchive archive, string parentFolderFullName, PdfName portfolioFieldKey)
{
    foreach (PdfFileSpecification fileSpecification in files)
    {
