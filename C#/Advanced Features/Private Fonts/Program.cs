...
using (var formattedText = new PdfFormattedText())
{
    ...
    _ = formattedText.AppendLine("Hello World 1!");
    ...
    _ = formattedText.AppendLine("Hello World 2!");
    ...
    _ = formattedText.AppendLine("Hello World 3!");
    ...
    _ = formattedText.Append("Hello World 4!");
