...
void Example1()
{
    ...
    PdfPathContent path = page.Content.Elements.AddPath();
    ...
    PdfContentFormat format = path.Format;
...
void Example2()
{
    ...
    PdfPathContent line = page.Content.Elements.AddPath().BeginSubpath(25, 550).LineTo(475, 550);
    format = line.Format;
    format.Stroke.IsApplied = true;
...
void Example3()
{
    ...
    PdfContentGroup textGroup = page.Content.Elements.AddGroup();
    ...
    PdfContentFormat format = textGroup.Format;
    format.Fill.IsApplied = false;
    format.Stroke.IsApplied = true;
    ...
    // Add a new content group. Clipping is localized to the content group.
    PdfContentGroup pathGroup = page.Content.Elements.AddGroup();
...
void Example5()
{
    ...
    PdfPathContent path = uncoloredTilingPattern.Content.Elements.AddPath();
    ...
    PdfPathContent backgroundRect = page.Content.Elements.AddPath();
    backgroundRect.AddRectangle(mediaBox.Left, mediaBox.Bottom, mediaBox.Width, mediaBox.Height);
    PdfContentFormat format = backgroundRect.Format;
    format.Fill.IsApplied = true;
    ...
    PdfPathContent redRect = page.Content.Elements.AddPath();
    ...
    PdfPathContent greenRect = page.Content.Elements.AddClone(redRect);
    ...
    PdfPathContent blueRect = page.Content.Elements.AddClone(greenRect);
    ...
    PdfPathContent redGreenRect = page.Content.Elements.AddPath();
...
void Example6()
{
    ...
    PdfPathContent square = page.Content.Elements.AddPath();
    ...
    PdfContentGroup textGroup = page.Content.Elements.AddGroup().Elements.AddGroup();
    ...
    PdfPathContent path = textGroup.Elements.AddPath(textGroup.Elements.First);
    ...
    PdfContentGroup pathGroup = page.Content.Elements.AddGroup().Elements.AddGroup();
    ...
    // In this case shading doesn't start from the bottom-left corner of the page, but from the bottom-left corner of the group.
    PdfShadingContent shadingContent = pathGroup.Elements.AddShading(shading);
