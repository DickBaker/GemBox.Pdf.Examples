...
void Example1()
{
    ...
    PdfSignatureField signatureField = document.Form.Fields.AddSignature();
...
void Example2()
{
    ...
    PdfSignatureField signatureField = document.Form.Fields.AddSignature(document.Pages[0], 300, 500, 250, 100);
...
void Example3()
{
    ...
    PdfSignatureField signatureField1 = document.Form.Fields.AddSignature(document.Pages[0], 100, 500, 200, 50);
    ...
    _ = signatureField1.Sign(signer1);
    ...
    PdfSignatureField signatureField2 = document.Form.Fields.AddSignature(document.Pages[0], 300, 500, 250, 50);
    ...
    _ = signatureField2.Sign(signer2);
...
void Example5()
{
    ...
    for (var i = 0; i < signatureFields.Count; ++i)
    {
        ...
        {
            _ = document.Form.Fields.Remove(signatureFields[i]);
        }
    }
